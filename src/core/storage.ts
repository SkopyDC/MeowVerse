...
export const freshProgress=():Progress=>({schemaVersion:SCHEMA_VERSION,fish:20,diamonds:0,medals:0,pondLevel:1,pondAt:Date.now()-300000,collection:Object.fromEntries(STARTER_CAT_IDS.map(id=>[id,defaultOwned(id==="kapka"?"pond":"pvp",starterCounts[id])])),pvpTeam:[...STARTER_CAT_IDS],battleDeck:[...STARTER_DECK],deployedCatId:"jiskra",milk:0,dairyLevel:1,dairyAt:Date.now()-120000,cheese:0,sandwiches:0,snacks:1,crafting:null,orderIndex:0,playerLevel:1,playerXp:0,tutorialStep:0,pendingCatId:null,wins:0,losses:0,soundEnabled:true,belt:"white",defeatedSenseiTrials:[],senseiAttempts:{},profileFrame:"frame-white"});
